...
function KernelMenu:new()
  local instance = setmetatable({}, KernelMenu)
  instance.manager = KernelManager:new()
  instance.package = TomlManager:new()
...
function KernelMenu:show(manager)
  local kernels = self.manager:get_kernels(manager)
  ...
  vim.api.nvim_buf_set_keymap(buf, 'n', 'd',
    [[<cmd>lua require('notebook_manager.kernel.menu')._delete_kernel()<CR>]],
...
function KernelMenu._delete_kernel()
  local self = KernelMenu:new()
  self:delete()
end
